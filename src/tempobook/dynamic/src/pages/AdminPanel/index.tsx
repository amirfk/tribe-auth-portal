...
const TempoComponent = () => {
  const notifyStoryRenderedArgs = () => {
    const notification = { filepath: '/home/peter/tempo-api/projects/0a/96/0a96ffb1-51b7-4c33-99c8-c30467fc5f4e/src/pages/AdminPanel.tsx', componentName: 'AdminPanel', args };
