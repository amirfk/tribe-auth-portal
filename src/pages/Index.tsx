...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-turquoise via-lime-green to-soft-peach"></div>
      ...
      <div className="relative z-10 min-h-screen">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link to="/register">
                  <Button className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white font-body shadow-lg">
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <div className="flex justify-center gap-6 flex-wrap animate-fade-in-up">
              <Link to={user ? "/ai-coach" : "/register"}>
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white text-lg px-10 py-4 rounded-full shadow-xl font-body"
                >
              ...
              <Link to="/store">
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-foreground text-lg px-10 py-4 rounded-full backdrop-blur-sm bg-white/10 shadow-xl font-body"
                >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="p-8 text-center bg-white/95 backdrop-blur-sm border-0 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-heading text-foreground mb-4">کوچینگ هوشمند</h3>
            ...
            <Card className="p-8 text-center bg-white/95 backdrop-blur-sm border-0 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-r from-accent to-turquoise rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Heart className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-2xl font-heading text-foreground mb-4">حمایت روانی</h3>
              <p className="text-muted-foreground font-body leading-relaxed">
            ...
            <Card className="p-8 text-center bg-white/95 backdrop-blur-sm border-0 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-r from-soft-peach to-primary rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Shield className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-2xl font-heading text-foreground mb-4">محرمانگی کامل</h3>
              <p className="text-muted-foreground font-body leading-relaxed">
        ...
        <footer className="bg-gradient-to-l from-warm-beige to-soft-peach border-t border-white/20 py-12 mt-20">
          <div className="container mx-auto px-4 text-center">
            <div className="flex justify-center items-center gap-3 mb-6">
              ...
              />
              <span className="text-lg font-heading text-foreground">Mina's Tribe</span>
            </div>
